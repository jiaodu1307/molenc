#!/usr/bin/env python3
"""
SchNet Encoder Test Script
Tests the SchNet molecular encoder API endpoints
"""
...
# Configuration
BASE_URL = "http://localhost:8004"  # SchNet service port
API_BASE = f"{BASE_URL}"
NGINX_URL = "http://localhost/api/schnet"  # Nginx proxy URL
...
def run_all_tests():
    """Run all tests"""
    print("=" * 60)
    print("SchNet Encoder API Test Suite")
    print("=" * 60)
...
if __name__ == "__main__":
    print("Make sure the SchNet service is running before testing!")
    print("You can start it with: docker-compose up -d schnet")
    print()
