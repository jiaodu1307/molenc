"""Demonstration of using the ChemBERTa pre-trained model for molecular encoding.

This script shows how to use the ChemBERTa encoder to convert SMILES strings 
into molecular embeddings using transformer-based models.
"""
...
def main():
    """Run the ChemBERTa demonstration."""
    print("=== ChemBERTa Pre-trained Model Demonstration ===\n")
    ...
    print("1. Creating ChemBERTa Encoder")
    print("-" * 30)
    
    try:
        # Create ChemBERTa encoder - this will automatically handle environment setup
    ...
    print("=== ChemBERTa Demonstration Completed ===")
    return True
